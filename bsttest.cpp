...
void testJohn01()
{ //Testing delete, height, and number of nodes
  cout << "Starting testJohn01" << endl;
  BST<string> B1;
  BST<string> B2;
  for (auto &S : vector<string>{"a", "b", "c", "d", "e", "f", "g", "h", "i"})
    B1.add(S);
  //cout << B1 << endl;
  B1.rebalance();
  //cout << B1 << endl;
  for (auto &S : vector<string>{"e", "b", "a", "c", "d", "g", "f", "h", "i"})
  B2.add(S);
  //cout << B2 << endl;
  //B2.rebalance();
  //cout << B2 << endl;
